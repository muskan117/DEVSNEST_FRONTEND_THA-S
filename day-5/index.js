...
solution -- var is_array = function(input) {
  ...
  /*2--Write a JavaScript function to get the first element of an array. Passing a
parameter 'n' will return the first 'n' elements of the array.

  solution --const array1 = [1,2,3,4,5]
...
parameter 'n' will return the first 'n' elements of the array.
 ...
 solution --var first =  function(array, n) {
  if (array == null) 
  return void 0;
if (n == null) 
  return array[0];
...
solution--   myColor = ["Red", "Green", "White", "Black"];
console.log(myColor.toString());
console.log(myColor.join());
console.log(myColor.join('+'));
*/
/* 5-- Write a JavaScript program to find the most frequent item of an array
 solution--var arr1=[3, 'a', 'a', 'a', 2, 3, 'a', 3, 'a', 2, 4, 9, 3];
var mostfreq = 1;
var m = 0;
var item;
